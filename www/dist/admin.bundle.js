...
window.naja = naja__WEBPACK_IMPORTED_MODULE_0__["default"];

// We must attach Naja to window load event.
document.addEventListener('DOMContentLoaded', () => naja__WEBPACK_IMPORTED_MODULE_0__["default"].initialize({
  history: false
}));
$(document).ready(function () {
  $('.modal').modal();
...
/* harmony import */ var _modules_admin_style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/admin/style.scss */ "./modules/admin/style.scss");
/* harmony import */ var _ui_naja__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ui/naja */ "./ui/naja.js");
